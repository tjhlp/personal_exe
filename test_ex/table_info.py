...
data = {'job_dsl': {'components': {'dataio_0': {'module': 'DataIO', 'input': {'data': {'data': ['args.train_data']}},
        ...
        'job_runtime_conf': {'initiator': {'role': 'guest', 'party_id': 16800},
                             ...
                             'role_parameters': {'guest': {
                                 'args': {
                                     'data': {'train_data': [{'name': 'breast_hetero_mini_guest', 'namespace': 'test'}],
                                              'eval_data': [
                                                  {'name': 'breast_hetero_mini_guest', 'namespace': 'test'}]}},
                                 ...
                                 'data': {'train_data': [{'name': 'longhua_company_penalty', 'namespace': 'test'}],
                                          'eval_data': [{'name': 'longhua_company_penalty', 'namespace': 'test'}]}},
...
data1 = {'job_dsl': {'components': {'dataio_0': {'module': 'DataIO', 'input': {'data': {'data': ['args.train_data']}},
         ...
         'job_runtime_conf': {'initiator': {'role': 'guest', 'party_id': 16800},
                              'job_parameters': {'work_mode': 1, 'processors_per_node': 1},
                              'role': {'guest': [16800], 'host': [16899], 'arbiter': [16800]}, 'role_parameters': {
                 'guest': {'args': {'data': {'train_data': [{'name': 'breast_hetero_mini_guest', 'namespace': 'test'}],
                     ...
                     'data': {'train_data': [{'name': 'breast_hetero_mini_host', 'namespace': 'test'}],
                              'eval_data': [{'name': 'breast_hetero_mini_host', 'namespace': 'test'}]}}, 'dataio_0': {
